...
public abstract class SendEvent {
     ...
     * @param url the URL we're posting to, this is either the default {@link com.action.amp.alexa.data.Directive} or {@link com.action.amp.alexa.data.Event} URL
    ...
    /**
     * Get our JSON {@link com.action.amp.alexa.data.Event} for this call
     * @return the JSON representation of the {@link com.action.amp.alexa.data.Event}
     */
    @NotNull
