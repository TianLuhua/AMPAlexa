...
import com.action.amp.alexa.callbacks.AuthorizationCallback;
import com.action.amp.alexa.data.Event;
import com.action.amp.alexa.interfaces.AvsException;
import com.action.amp.alexa.interfaces.AvsItem;
import com.action.amp.alexa.interfaces.AvsResponse;
import com.action.amp.alexa.interfaces.GenericSendEvent;
import com.action.amp.alexa.interfaces.audioplayer.AvsPlayAudioItem;
import com.action.amp.alexa.interfaces.response.ResponseParser;
import com.action.amp.alexa.interfaces.speechrecognizer.SpeechSendAudio;
import com.action.amp.alexa.interfaces.speechrecognizer.SpeechSendText;
import com.action.amp.alexa.interfaces.speechrecognizer.SpeechSendVoice;
import com.action.amp.alexa.interfaces.speechsynthesizer.AvsSpeakItem;
import com.action.amp.alexa.requestbody.DataRequestBody;
import com.action.amp.alexa.service.DownChannelService;
import com.action.amp.alexa.system.AndroidSystemHandler;
import com.action.amp.alexa.utility.Util;
...
import static com.action.amp.alexa.AuthorizationManager.createCodeVerifier;
import static com.action.amp.alexa.interfaces.response.ResponseParser.getBoundary;
import static com.action.amp.alexa.utility.Util.IDENTIFIER;
...
public class AlexaManager {
    ...
    /**
     * Send a synchronize state {@link Event} request to Alexa Servers to retrieve pending {@link com.action.amp.alexa.data.Directive}
     ...
     * See: {@link #sendEvent(String, AsyncCallback)}
     *
     * @param volume volume as reported by the {@link com.action.amp.alexa.interfaces.speaker.AvsAdjustVolumeItem} Directive
     ...
     * See: {@link #sendEvent(String, AsyncCallback)}
     *
     * @param isMute mute state as reported by the {@link com.action.amp.alexa.interfaces.speaker.AvsSetMuteItem} Directive
     * @param callback
     */
    ...
    /**
     * Send a generic event to the AVS server, this is generated using {@link com.action.amp.alexa.data.Event.Builder}
