package com.action.amp.ampalexa;
...
import com.action.amp.alexa.AlexaManager;
import com.action.amp.alexa.audioplayer.AlexaAudioPlayer;
import com.action.amp.alexa.callbacks.AsyncCallback;
import com.action.amp.alexa.interfaces.AvsItem;
import com.action.amp.alexa.interfaces.AvsResponse;
import com.action.amp.alexa.interfaces.audioplayer.AvsPlayAudioItem;
import com.action.amp.alexa.interfaces.audioplayer.AvsPlayContentItem;
import com.action.amp.alexa.interfaces.audioplayer.AvsPlayRemoteItem;
import com.action.amp.alexa.interfaces.errors.AvsResponseException;
import com.action.amp.alexa.interfaces.playbackcontrol.AvsMediaNextCommandItem;
import com.action.amp.alexa.interfaces.playbackcontrol.AvsMediaPauseCommandItem;
import com.action.amp.alexa.interfaces.playbackcontrol.AvsMediaPlayCommandItem;
import com.action.amp.alexa.interfaces.playbackcontrol.AvsMediaPreviousCommandItem;
import com.action.amp.alexa.interfaces.playbackcontrol.AvsReplaceAllItem;
import com.action.amp.alexa.interfaces.playbackcontrol.AvsReplaceEnqueuedItem;
import com.action.amp.alexa.interfaces.playbackcontrol.AvsStopItem;
import com.action.amp.alexa.interfaces.speaker.AvsAdjustVolumeItem;
import com.action.amp.alexa.interfaces.speaker.AvsSetMuteItem;
import com.action.amp.alexa.interfaces.speaker.AvsSetVolumeItem;
import com.action.amp.alexa.interfaces.speechrecognizer.AvsExpectSpeechItem;
import com.action.amp.alexa.interfaces.speechsynthesizer.AvsSpeakItem;
import com.action.amp.ampalexa.actions.BaseListenerFragment;

import java.util.ArrayList;
import java.util.List;

import static com.action.amp.ampalexa.global.Constants.PRODUCT_ID;
...
//        alexaManager.sendOpenDownchannelDirective(requestCallback);
     ...
     * https://developer.amazon.com/public/solutions/alexa/alexa-voice-service/reference/audioplayer#PlaybackNearlyFinished Event
     */
    private void sendPlaybackStartedEvent(AvsItem item, long offsetInMilliseconds) {
        alexaManager.sendPlaybackStartedEvent(item, offsetInMilliseconds, null);
